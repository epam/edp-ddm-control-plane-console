...
type registry struct {
	...
	TrembitaClientEnabled         string   `form:"trembita-client-enabled"`
	TrembitaClientID              string   `form:"trembita-client-id"`
	TrembitaClientProtocolVersion string   `form:"trembita-client-protocol-version"`
	TrembitaClientXRoadInstance   string   `form:"trembita-client-x-road-instance"`
	TrembitaClientMemberClass     string   `form:"trembita-client-member-class"`
	TrembitaClientMemberCode      string   `form:"trembita-client-member-code"`
	TrembitaClientSubsystemCode   string   `form:"trembita-client-subsystem-code"`
}
