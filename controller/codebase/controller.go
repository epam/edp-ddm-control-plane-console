...
func (c *Controller) updateImportRepo(ctx context.Context, instance *codebaseService.Codebase) error {
	if value, key := instance.ObjectMeta.Annotations[registry.AnnotationTemplatePushedStatus]; !key || value != "false" {
		return nil
	}
	...
	instance.ObjectMeta.Annotations[registry.AnnotationTemplatePushedStatus] = "true"
