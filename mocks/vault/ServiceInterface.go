...
// GetPropertyFromVault provides a mock function with given fields: path, property
func (_m *ServiceInterface) GetPropertyFromVault(path string, property string) string {
	ret := _m.Called(path, property)
